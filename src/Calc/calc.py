...
class CalcFrame(wx.Frame):
    ...
    def __init__(self, title):
        super(CalcFrame, self).__init__(None, title=title, size=(350, 300))   
        self.InitUI()
        self.Centre()
        self.Show()     
    ...
    def InitUI(self):     
        ...
        self.textprint = wx.TextCtrl(self,style=wx.TE_RIGHT|wx.TE_READONLY)#wx.TE_READONLY表示不支持键盘输入
        ...
        labels=['AC','DEL','CLOSE','%','7','8','9','/','4','5','6',
                '*','1','2','3','-','0','.','=','+']
        for label in labels:
